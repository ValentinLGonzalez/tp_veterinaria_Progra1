from entities.veterinarians.entity import create_veterinarian, delete_veterinarian_by_id, get_veterinarian_by_dni, show_veterinarian, update_veterinarian_by_id, update_veterinarian_data
