...
def validate_veterinarian_dni(input_dni):
    get_dni = get_data_veterinarian_by_dni(input_dni)
    return (not bool(get_data_veterinarian_by_dni(input_dni)) or get_dni[HEADER_VETERINARIAN.index("dni")] == input_dni) and is_valid_dni(input_dni)
